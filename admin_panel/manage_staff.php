...
?>
                                        ...
                                        <?php foreach ($staff as $row) {?>
                                            <tr>
                                                ...
                                                <td style="width:20%">
                                                    ...
                                                    <a class="btn btn-info" href="manage_record.php?id=<?= $row['IDS']; ?>">
    ...
    <?php
    include 'modal/staffedit_modal.php';
    include 'modal/staffdel_modal.php';
    ?>
